 ...
 */
public class DetailActiFrag extends Fragment {
    ...
    public static DetailActiFrag newInstance(Movie newMovie) {
        Bundle args = new Bundle();
        DetailActiFrag fragment = new DetailActiFrag();
